...
const char* paletteNameList[14] = {"GRAY\0", "RED\0", "ORANGE\0", "YELLOW\0", "GREEN\0", "BLUE\0", "INDIGO\0", "VIOLET\0", "BLUEBERRYJAM\0", "ZERORANGER\0", "DEPTHS\0", "NIGHT\0", "MILK\0", "CUSTOM\0"};
