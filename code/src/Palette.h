...
extern bn::array<bn::color, 16> whiteOutlineArray;
...
public:
	...
	constexpr void update() {
		...
		colorArray = {a, b, c, d, e, bn::color(0, 0, 0), bn::color(0, 0, 0), bn::color(0, 0, 0), bn::color(0, 0, 0), bn::color(0, 0, 0), bn::color(0, 0, 0), bn::color(0, 0, 0), bn::color(0, 0, 0), bn::color(0, 0, 0), bn::color(0, 0, 0), bn::color(0, 0, 0)};
		whiteOutlineArray = {a, c, b, d, e, bn::color(0, 0, 0), bn::color(0, 0, 0), bn::color(0, 0, 0), bn::color(0, 0, 0), bn::color(0, 0, 0), bn::color(0, 0, 0), bn::color(0, 0, 0), bn::color(0, 0, 0), bn::color(0, 0, 0), bn::color(0, 0, 0), bn::color(0, 0, 0)};
	...
	/*const bn::sprite_palette_item getOutlineFontSpritePalette() {

		bn::span<bn::color> spanthing(fontOutlineColorArray);
	...
	const bn::sprite_palette_item getBlackOutlinePalette() {
		return getSpritePalette();
	}

	const bn::sprite_palette_item getWhiteOutlinePalette() {

		// i hate using a whole other array for this, but i remember the pain
		bn::span<bn::color> spanthing(whiteOutlineArray);
