...
constexpr const char* randomBoulderMessages[] = {
	...
	"Sorry.\0",
	"i have been thinking\0",
	"im adding this whimsy back. i need to accept my cringe, and reject the part that cringes\0", // <3
	"by the way, im doing better now. i sorta have a job, but regardless of that, i am happier. Dont tie your happiness to if you have a job. very bad move.\0",
	"with love, INA <3\0",
};
